...
- `scripts/check_frontend_integrity.py`: verifies project HTML, labels, local ES modules, DOM wiring, trace-copy controls, keyboard trace deep links, scenario-draft controls, and quick-action controls.
...
- `docs/frontend_integrity.md`: frontend wiring, trace-copy, keyboard trace-link, and scenario-draft controls, no-build local UI posture, and review framing.
