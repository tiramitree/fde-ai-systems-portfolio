...
Use this guide with `docs/scenario_data_integrity.md`, `docs/eval_gate_troubleshooting_examples.md`, `docs/api_contracts.md`, and the project-level `evals.py` runner before changing regression coverage.
