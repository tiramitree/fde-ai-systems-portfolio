...
4. Add a compact README reviewer checklist for comparing the screenshot gallery with live demo behavior.
5. Add a compact README command decision tree for choosing local, release, GitHub, and optional environment checks.
