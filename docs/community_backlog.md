...
2. Add compact stale GitHub Discussions pin examples.
3. Add compact stale release-page screenshot examples.
4. Add compact stale profile-pin evidence examples.
5. Add compact stale social-preview cache examples.
