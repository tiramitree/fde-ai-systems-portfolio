...
2. Add compact stale Dependabot alert evidence examples.
3. Add compact stale GitHub release asset evidence examples.
4. Add compact stale GitHub label sync evidence examples.
5. Add compact stale GitHub Actions workflow-run evidence examples.
