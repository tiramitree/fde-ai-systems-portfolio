...
2. Add a compact README PR triage evidence pointer.
3. Add a compact README threat model evidence pointer.
4. Add a compact README workflow security evidence pointer.
5. Add a compact README governance evidence pointer.
