...
2. Add a compact README launch asset evidence pointer.
3. Add a compact README reviewer handoff evidence pointer.
4. Add a compact README post-publish evidence pointer.
5. Add a compact README GitHub readiness evidence pointer.
