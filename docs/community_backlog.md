...
2. Add compact public roadmap issue comment examples.
3. Add compact release asset upload dry-run examples.
4. Add compact repository discussions launch checklist.
5. Add compact release note refresh checklist.
