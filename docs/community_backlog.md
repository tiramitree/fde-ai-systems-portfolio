...
2. Add a compact README Docker runtime evidence pointer.
3. Add a compact README dependency surface evidence pointer.
4. Add a compact README API contract evidence pointer.
5. Add a compact README error hygiene evidence pointer.
