...
2. Add a compact README optional-environment evidence pointer.
3. Add a compact README connector roadmap pointer.
4. Add a compact README eval regression report pointer.
5. Add a compact README storage adapter evidence pointer.
