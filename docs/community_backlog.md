...
2. Add a trace timeline explainer for one canonical flow per project.
3. Add contributor-local troubleshooting examples for failed eval gates.
4. Add a small glossary for seed, runtime, eval, replay, and trace artifacts.
5. Add a command-output troubleshooting map for the most common failing gates.
