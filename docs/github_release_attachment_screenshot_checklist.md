...
Use this page when collecting or reviewing screenshots that show release replay artifacts attached to GitHub. Read it with `docs/release_attachment_verification_examples.md`, `docs/github_release_page_troubleshooting_examples.md`, `docs/github_latest_release_troubleshooting_examples.md`, `docs/post_publish_checklist.md`, `docs/post_publish_warning_examples.md`, and `docs/command_output_troubleshooting_map.md`.
