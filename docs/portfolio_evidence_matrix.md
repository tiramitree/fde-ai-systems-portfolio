...
| Running UI routes are served intentionally. | `scripts/check_runtime_ui_contracts.py`, project `app.py` files | `python -B scripts/dev.py ui-contracts` | The running demos serve local HTML/CSS/JS with stable content types, basic safety headers, JSON 404s, and traversal blocking. |
