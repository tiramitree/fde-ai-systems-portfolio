...
| Generated artifact | File produced by a command rather than hand-authored source content. | Generated, sometimes tracked only as intentional release evidence. | `docs/demo_report.md`; `eval_summaries.csv`; `otel_traces.json`; `out/demo_replay_artifact.*`; `*/data/runtime_state.json`; `*/data/eval_runtime_state.json`. | Review generated diffs carefully and keep private paths, tokens, real customer data, and stale runtime evidence out of commits. |
