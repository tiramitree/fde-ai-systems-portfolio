...
STALE_SOCIAL_PREVIEW_CACHE_EXAMPLES = ROOT / "docs" / "stale_social_preview_cache_examples.md"
...
def check_discussion_to_issue_conversion_examples() -> list[str]:
    failures: list[str] = []
    if not DISCUSSION_TO_ISSUE_CONVERSION_EXAMPLES.exists():
        return ["missing docs/discussion_to_issue_conversion_examples.md"]

    text = DISCUSSION_TO_ISSUE_CONVERSION_EXAMPLES.read_text(encoding="utf-8")
    required_phrases = [
    ...
    for phrase in required_phrases:
        if phrase not in text:
            failures.append(f"docs/discussion_to_issue_conversion_examples.md: missing {phrase!r}")
...
def check_social_preview_verification_examples() -> list[str]:
    ...
    cross_references = {
        ...
        "docs/stale_social_preview_cache_examples.md": "docs/social_preview_verification_examples.md",
...
def check_stale_social_preview_cache_examples() -> list[str]:
    failures: list[str] = []
    if not STALE_SOCIAL_PREVIEW_CACHE_EXAMPLES.exists():
        return ["missing docs/stale_social_preview_cache_examples.md"]

    text = STALE_SOCIAL_PREVIEW_CACHE_EXAMPLES.read_text(encoding="utf-8")
    required_phrases = [
        ...
        "Private Account UI Crops",
        "Review Checklist",
        "local preview assets, uploaded social preview, cached cards, profile pin setup, account UI screenshots, and source docs prove different things",
        "Do not claim social preview setup is current until visible GitHub evidence confirms it",
        "old social-preview images, wrong uploaded images, cache delays, profile-pin confusion, and private account UI crops",
        "Social-preview screenshots are review aids",
        "they do not replace the GitHub repository settings page, the public repository card, or readiness warning rows",
        "Private account screenshots, account menus, notifications, private repository lists, local paths, browser profile details, and tokens are not committed",
        "python -B scripts/dev.py assets",
        "python -B scripts/dev.py github-readiness",
        "python -B scripts/dev.py launch-assets",
    ...
    for phrase in required_phrases:
        if phrase not in text:
            failures.append(f"docs/stale_social_preview_cache_examples.md: missing {phrase!r}")

    cross_references = {
        "README.md": "docs/stale_social_preview_cache_examples.md",
        "PROJECT_CONTENT_INDEX.md": "docs/stale_social_preview_cache_examples.md",
        "docs/post_publish_checklist.md": "docs/stale_social_preview_cache_examples.md",
        "docs/social_preview_verification_examples.md": "docs/stale_social_preview_cache_examples.md",
        "docs/profile_pin_verification_examples.md": "docs/stale_social_preview_cache_examples.md",
        "docs/stale_profile_pin_evidence_examples.md": "docs/stale_social_preview_cache_examples.md",
        "docs/github_repository_settings_screenshot_checklist.md": "docs/stale_social_preview_cache_examples.md",
        "docs/post_publish_warning_examples.md": "docs/stale_social_preview_cache_examples.md",
    }
    for rel_path, phrase in cross_references.items():
        if phrase not in (ROOT / rel_path).read_text(encoding="utf-8"):
            failures.append(f"{rel_path}: missing {phrase!r}")
...
def check_profile_pin_verification_examples() -> list[str]:
    ...
    cross_references = {
        ...
        "docs/stale_social_preview_cache_examples.md": "docs/profile_pin_verification_examples.md",
...
def check_stale_profile_pin_evidence_examples() -> list[str]:
    ...
    cross_references = {
        ...
        "docs/stale_social_preview_cache_examples.md": "docs/stale_profile_pin_evidence_examples.md",
...
def check_github_release_attachment_screenshot_checklist() -> list[str]:
    failures: list[str] = []
    if not GITHUB_RELEASE_ATTACHMENT_SCREENSHOT_CHECKLIST.exists():
        return ["missing docs/github_release_attachment_screenshot_checklist.md"]

    text = GITHUB_RELEASE_ATTACHMENT_SCREENSHOT_CHECKLIST.read_text(encoding="utf-8")
    required_phrases = [
    ...
    for phrase in required_phrases:
        if phrase not in text:
            failures.append(f"docs/github_release_attachment_screenshot_checklist.md: missing {phrase!r}")
...
def check_release_note_refresh_checklist() -> list[str]:
    failures: list[str] = []
    if not RELEASE_NOTE_REFRESH_CHECKLIST.exists():
        return ["missing docs/release_note_refresh_checklist.md"]

    text = RELEASE_NOTE_REFRESH_CHECKLIST.read_text(encoding="utf-8")
    required_phrases = [
    ...
    for phrase in required_phrases:
        if phrase not in text:
            failures.append(f"docs/release_note_refresh_checklist.md: missing {phrase!r}")
...
def main() -> int:
    ...
    failures.extend(check_stale_social_preview_cache_examples())
