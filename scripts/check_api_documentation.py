...
PROJECTS = {
    "Secure Enterprise Knowledge Copilot": {
        ...
        "fields": {
            ...
            "retrieval_profile.source_lifecycle_policy",
            "retrieval_profile.stale_filtered_count",
            "candidate_strategy",
            ...
            "citations[].evidence_excerpt",
            "citations[].evidence_spans",
            "evidence_spans[].source_span",
            "embedding_model",
            ...
            "acl_source",
            "acl_snapshot",
            "acl_snapshot.version",
            "acl_snapshot.documents",
            "sync_cursor",
            ...
            "source_bundle_catalog_v1",
            "catalog.raw_bodies_returned",
            ...
            "parser.contract_version",
            "parser.quality_schema_version",
            "parser.quality",
            "parser.quality.schema_version",
            "raw_body_returned",
            "would_index",
            "source_scan.schema_version",
            "source_scan.raw_matches_returned",
...
def check_error_examples() -> list[str]:
    ...
    required_phrases = [
        ...
        "Only supervisors can reject actions.",
        "Only supervisors can expire actions.",
