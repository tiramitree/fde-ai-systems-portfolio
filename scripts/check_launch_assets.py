...
REQUIRED_PHRASES = {
    ...
    "docs/published_repository_status.md": [
        ...
        "docs/public_maintainer_status_update_examples.md",
        "Keep local quality, pushed code, remote GitHub evidence, account-level/manual setup, and roadmap promises separate",
        "docs/dependabot_secret_scanning_verification_examples.md",
        "docs/stale_dependabot_alert_evidence_examples.md",
        "docs/github_discussions_launch_checklist.md",
    ...
    "docs/post_publish_checklist.md": [
        ...
        "the roadmap duplicate issue handling examples are published",
        "the issue template stale-evidence examples are published",
        "the contributor attribution examples are published",
        "the issue triage SLA wording examples are published",
        "the discussion-to-issue conversion examples are published",
        "the GitHub Discussions launch checklist is published",
        "the stale GitHub Discussions pin examples are published",
        "the Dependabot and secret-scanning verification examples are published",
        "the stale Dependabot alert evidence examples are published",
        ...
        "the stale repository topics evidence examples are published",
        "the stale branch-protection screenshot examples are published",
        "the release attachment verification examples are published",
        "the release asset upload dry-run examples are published",
        "the release asset checksum mismatch examples are published",
        "the release note refresh checklist is published",
        "the release note changelog drift examples are published",
        "the GitHub release attachment screenshot checklist is published",
        "the stale release-page screenshot examples are published",
        ...
        "the stale social-preview cache examples are published",
        "the profile pin verification examples are published",
        "the stale profile-pin evidence examples are published",
        "the post-publish warning examples are published",
        "the public maintainer status update examples are published",
        "the GitHub Actions badge verification examples are published",
        "the stale GitHub Actions badge cache examples are published",
        "the launch feedback collection examples are published",
        "the stale launch-feedback claim examples are published",
        "python -B scripts/dev.py launch-assets",
    ],
    "docs/final_readiness_report.md": [
        "python -B scripts/dev.py launch-assets",
