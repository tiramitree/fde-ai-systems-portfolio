...
def render() -> str:
    ...
    lines = [
        ...
        *blockers(github_checks),
        ...
        "8. Run `python -B scripts/dev.py visual-asset-diff` and `python -B scripts/dev.py visual-assets` to prove desktop and mobile screenshots are tied to current frontend source hashes and reviewable without binary log output.",
