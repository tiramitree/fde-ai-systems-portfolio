...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=(
            "start: run both demo servers; assets/contracts/health/evals/eval-csv/github-readiness/otel-traces/replay/smoke/report/safety/quality: run individual gates; "
