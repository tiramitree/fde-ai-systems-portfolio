...
COMMANDS = {
    ...
    "auth-boundary": ["scripts/check_auth_boundary.py"],
    ...
    "governance-controls": ["scripts/check_ai_governance_controls.py"],
    ...
    "parser-quality": ["scripts/check_project1_parser_quality_contract.py"],
    "source-scan": ["scripts/check_project1_source_scan_contract.py"],
    ...
    "request-body-limits": ["scripts/check_request_body_limits.py"],
    "request-correlation": ["scripts/check_request_correlation.py"],
    "request-governance": ["scripts/check_request_governance.py"],
    "retrieval-metrics": ["scripts/check_project1_retrieval_metrics.py"],
    ...
    "reviewed-eval-ledger": ["scripts/check_reviewed_eval_ledger.py"],
    "runtime-latency-budget": ["scripts/check_runtime_latency_budget.py"],
    "runtime-state-isolation": ["scripts/check_runtime_state_isolation.py"],
    ...
    "trace-redaction": ["scripts/check_trace_redaction.py"],
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=(
            "start: run all demo servers; api-docs/architecture/auth-boundary/assets/claims/community-issues/container-release/docker-runtime/dependency-surface/demo-presets/contracts/error-hygiene/health/evals/eval-csv/frontend/fresh-clone/fresh-clone-local/github-community/github-launch-setup/github-maintenance/github-readiness/governance/governance-controls/launch-assets/model-gateway-safety/observability/openai-live/otel-collector-handoff/otel-traces/parser-quality/source-scan/postgres-compose/postgres-migrations/postgres-runtime/postgres-seed/pr-policy/pr-triage/request-body-limits/request-correlation/request-governance/readiness-report/refresh-visual-assets/replay/replay-artifact/runtime-latency-budget/runtime-state-isolation/scenario-data/smoke/report/safety/quality/threat-model/trace-redaction/trace-to-eval/trace-to-eval-check/ui-contracts/visual-assets/visual-asset-diff/workflow-security: run individual gates; "
